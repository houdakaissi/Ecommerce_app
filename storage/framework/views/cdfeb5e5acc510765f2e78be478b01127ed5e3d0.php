...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-8 offset-md-4">
                                <button  style="width:300px; background-color:black;" type="submit" class="btn btn-primary">
            ...
            <div style=" "  >
                ...
                <div class="form-group row mb-0">
                            <div  class="col-md-8 offset-md-4">
                                ...
                                <button     style="border-color:red;width:300px;  color:red; background-color:#F0FFF0;"   class="btn btn-primary">
