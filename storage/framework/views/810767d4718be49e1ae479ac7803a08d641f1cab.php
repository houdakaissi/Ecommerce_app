        ...
        <div class="col-md-12 card p-3">
           <strong> <h2 style="color:blue; " >Your cart</h2></strong>
            ...
            <?php if(Cart::getSubtotal() > 0): ?>
                <div class="form-group">
                    <a style="color:white;" href="<?php echo e(route("make.payment")); ?>" class="btn btn-primary mt-3">
            ...
            <?php if(Cart::getSubtotal() > 0): ?>
                <div class="form-group">
                    <a  style="color:white;" href=" <?php echo e(route('stripe.post')); ?> " class="btn btn-primary mt-3">
                        Payer <?php echo e(Cart::getSubtotal()); ?> $ via Carte bancaire
                    </a>
                </div>
            <?php endif; ?> 
