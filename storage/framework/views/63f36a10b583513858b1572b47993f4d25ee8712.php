...
<div class="row">
<div class="col-xs-12">
<button style="background-color: #21B6A8;width:350px;margin-left:40px;margin-top:10px;"class="btn btn-primary btn-lg btn-block" type="submit">Payer <?php echo e(Cart::getSubtotal()); ?>$ </button>
</div>
</div>
</form>
</div>
...
table  {
  ...
  border-color:gray;
     ...
     <?php endif; ?><?php /**PATH /opt/lampp/htdocs/laravel-ecommerce-channel/resources/views/stripe.blade.php ENDPATH**/ ?>