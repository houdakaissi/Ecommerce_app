        ...
        <div class="col-md-12 card p-3">
           <strong> <h2 style="color:blue; " >Your cart</h2></strong>
            ...
            @if(Cart::getSubtotal() > 0)
                <div class="form-group">
                    <a style="color:white;" href="{{ route("make.payment") }}" class="btn btn-primary mt-3">
            ...
            @if(Cart::getSubtotal() > 0)
                <div class="form-group">
                    <a  style="color:white;" href=" {{route('stripe.post')}} " class="btn btn-primary mt-3">
                        Payer {{ Cart::getSubtotal() }} $ via Carte bancaire
                    </a>
                </div>
            @endif 
