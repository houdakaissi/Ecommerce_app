...
Route::get('/gf', 'ProductController@search')->name('products.search1');
...
Route::get('stripe/facture', [StripeController::class,'paymentGood'])->name('success1.payment');    
Route::get('stripe/infoform', [StripeController::class,'infoform'])->name('infoform.post');  